...
class RootNavigationViewController: UIViewController, RootNavigationProtocol {
    ...
    weak var appController: AppControllerProtocol?
    ...
    func setRootContent(
        ...
        guard rootContent.getRootContentViewController() != currentContent?.getRootContentViewController()
        else {
            return
        }
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if !self.viewAppeared {
            ...
            self.appController?.onRootDidAppear()
        }
    }
    ...
    override var childForStatusBarStyle: UIViewController? {
        currentContent?.getRootContentViewController()
    }
        ...
        if previous != nil {
            UIView.animate(
                ...
                completion: { _ in
                    ...
                    previousContentViewController?.view.removeFromSuperview()
                    previousContentViewController?.removeFromParent()
                    previousContentViewController?.view.alpha = 1.0
            })
        } else {
            delay = 0.0
        }
